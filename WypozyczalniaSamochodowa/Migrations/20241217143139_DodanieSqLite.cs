...
{
    /// <inheritdoc />
    public partial class DodanieSqLite : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Zdjecie = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WynajecieId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AutoId = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    CenaCalkowita = table.Column<int>(type: "INTEGER", nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Wynajecie", x => x.WynajecieId);
                    table.ForeignKey(
                        name: "FK_Wynajecie_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Wynajecie_Auto_AutoId",
                        column: x => x.AutoId,
                        principalTable: "Auto",
                        principalColumn: "AutoId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Oferta_AutoId",
                table: "Oferta",
                column: "AutoId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Wynajecie_AutoId",
                table: "Wynajecie",
                column: "AutoId");

            migrationBuilder.CreateIndex(
                name: "IX_Wynajecie_UserId",
                table: "Wynajecie",
                column: "UserId");
        }
